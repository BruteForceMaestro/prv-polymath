# this is COPIED from the kimina lean client-server repository
# for some reason, everything is commented out in the kimina client package, specifically in the infotree part. 
# but the functions can appear to be really useful, so I'm adding them back in here.
